...
import './maplistings_lit.html';
 
var contentviewtab = []; 

  Template.maplistings_lit.onCreated(function() {


    
  //  this.autorun(() => {
  //   const hand = this.subscribe('campingcars');
  //   const isReady = hand.ready();
  //   console.log(`Handle is ${isReady ? 'ready' : 'not ready'}`);  
  //   //const hand2 = this.subscribe('communes');
  //   //this.subscribe('communes');
  //   const hannn = this.subscribe('communes');
  //   const isReady2 = hand2.ready();
  //   console.log(`Communes is ${isReady2 ? 'ready' : 'not ready'}`);  
...
// // return com;
 ...
 Template.maplistings_lit.onRendered(function(){
...
this.$('.datetimepickerstart').datetimepicker({
 ...
 Template.maplistings_lit.helpers({
...
console.log("Googlemaps load ok");
       return {
  ...
  Template.maplistings_lit.events({
