...
//Markers = new Mongo.Collection('markers');  
 ...
 Template.book.helpers({
    ...
    console.log("resa find! : "+Reservations.find({_id:FlowRouter.getParam("_id"),"status" : "pay_ok"}).count());
return Reservations.find({_id:FlowRouter.getParam("_id"),"status" : "pay_ok"}).fetch()[0];
  }
});
